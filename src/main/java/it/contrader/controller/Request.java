...
/*
 * la classe Request � un implementazione di una HashMap
...
public class Request {
	...
	/*
	 * tramite i generici dichiaro i tipi di variabili che la variabile accetter� in questo caso String per la chiave
	...
	/*
	 * metodo put:
	 * paramentri: String key : stringa che rapprenseter� la chiave di ricerca per il valore
	 * 							PS: se la chiave gia esiste il valore verr� sovrascritto
	 * 			   Object value : rapprenseta il valore associato alla chiave
	 * 							dichiarato come Object in quando pi� che un valore vero e proprio rappresenta una parte di memoria
	 * 							quindi potrei inserire come value un oggetto di tipo String , un Integer o volendo anche un 
	 * 							Oggetto pi� complesso come tutto un user
	 ...
	 * output: Object : l'output sar� l'oggetto associato alla chiave dovr� quindi eseguire in fase di richiamo il giusto cast in 
	 ...
	 * output: Object : l'output sar� il corrispettivo String del valore associato
	 ...
	 * 				PS: chiamare dall'esterno request.get(x).toString � la medesima cosa
	 */
